...
<div>
   <el-form :model="form" :inline="true" :rules="rules" ref="form" label-width="130px" class="demo-ruleForm">
        ...
        <el-form-item label="状态字符"  prop="value4">
          <el-input v-model="form.value4" type="textarea" style="width:330%" :autosize="{ minRows: 10, maxRows: 10}" size="small" placeholder="" autocomplete="off"></el-input>
        </el-form-item>
        </div>
        <el-form-item label="部门列表:" prop="checkedList">
        ...
        <el-form-item label="字符描述"  prop="value5">
          <el-input v-model="form.value5" type="textarea" style="width:330%" :autosize="{ minRows: 4, maxRows: 4}" size="small" placeholder="" autocomplete="off"></el-input>
        </el-form-item>
        </div>
