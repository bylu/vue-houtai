<template>
    <div class="showcontent">
      <div class="userOperaTitlecss">赠送会员查询操作:</div>
        <el-row :gutter="32">
        ...
        <el-row  :gutter="32">
            <el-col :span="24">
                <el-table :data="tableData" style="width: 100%" :cell-style="cellStyle" :header-cell-style="rowClass" border v-loading="tableloading">
                    ...
                    <el-table-column prop="curGold" label="赠送前" ></el-table-column>
                    <el-table-column prop="addGold" label="赠送"></el-table-column>

                  <el-table-column prop="addGold" label="赠送后" ></el-table-column>
