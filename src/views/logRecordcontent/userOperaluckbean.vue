<template>
    <div class="showcontent">
      <div class="userOperaTitlecss">赠送幸运豆查询操作:</div>
        <el-row :gutter="32">
        ...
        <el-row  :gutter="32">
          <el-col :span="24">
            <el-table :data="tableData" style="width: 100%" border v-loading="tableloading" :cell-style="cellStyle" :header-cell-style="rowClass">
              ...
              <el-table-column prop="accounts" label="赠送对象账号" width="200px"></el-table-column>
...
<script>
    export default {
        ...
        methods:{
            ...
            checkAddColor(data){
              if(data.username == '' || data.username == null){
                return "<span style='color:red'>"+ data.addGold +"</span>"
              }else{
                return "<span>"+ data.addGold +"</span>"
              }
            }
        }
    }
