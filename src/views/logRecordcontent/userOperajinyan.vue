<template>
    <div class="showcontent">
      <div class="userOperaTitlecss">禁言解禁查询操作:</div>
        <el-row :gutter="32">
            <el-form ref="form" :model="form">
                <el-col :xs="12" :sm="6" :lg="3">
                    <el-select v-model="form.type" placeholder="请输入" size="small">
                        <el-option v-for="(list,index) in selectList.operaJinyanTypelist" :key="index" :label="list.value" :value="list.key"></el-option>
                    </el-select>
                </el-col>
        ...
        <el-row  :gutter="32">
            <el-col :span="24">
                <el-table :data="tableData" style="width: 100%" :cell-style="cellStyle" :header-cell-style="rowClass" border v-loading="tableloading">
                    ...
                    <el-table-column prop="userId" label="操作对象用户ID" ></el-table-column>
                    <el-table-column prop="endDate" label="结束日期"></el-table-column>
                    <el-table-column prop="type" label="类型" >
                      <template slot-scope="scope">{{ scope.row.type | checkJinyanType }}</template>
                    </el-table-column>
    ...
    export default {
        ...
        methods:{
            ...
            onSubmit(pageNum){
              ...
              this.$api.recordUserOperationInforecordChatControl(param).then(res =>{
