  ...
  <div class="app-container">
    ...
    <el-row :gutter="32">
      <el-form ref="form" :model="form">
        ...
        <el-col :xs="24" :sm="24" :lg="6" v-has="'fishRaceBetLog_search'">
    ...
    <el-row>
      <el-col :span="24">
        <el-table :data="tableData" style="width: 100%" :cell-style="cellStyle" :header-cell-style="rowClass" border v-loading="tableloading">
          <el-table-column prop="uid" label="用户ID" width="100px"></el-table-column>
          <el-table-column prop="round" label="赛鱼时间" width="160px"></el-table-column>
          ...
          <el-table-column prop="recvAt" label="领取时间" width="160px">
            <template slot-scope="scope"> {{scope.row.recvAt | null2Zero }}</template>
          </el-table-column>
          <el-table-column prop="awardPoolAward" label="奖金池提供奖金" width="120px">
            <template slot-scope="scope">{{ scope.row.awardPoolAward | numTenthousand }}</template>
          </el-table-column>
          <el-table-column prop="winAwardScore" label="赢奖金池幸运豆" width="120px">
            <template slot-scope="scope">{{ scope.row.winAwardScore | numTenthousand }}</template>
          </el-table-column>
        </el-table>
    ...
    export default {
        ...
        methods:{
            ...
            onSubmit(pageNum){
              ...
              this.$api.fishRaceBetLogsearch(param).then(res =>{
