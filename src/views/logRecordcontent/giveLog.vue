<template>
  <div class="app-container">
    <h3 class="showTit">玩家赠送记录</h3>
    <el-row :gutter="32">
      <el-form ref="form" :model="form">
        <el-col :xs="24" :sm="6" :lg="3">
          <el-input v-model.trim="form.fromUid" size="small" placeholder="赠送者" clearable></el-input>
        </el-col>
        <el-col :xs="24" :sm="6" :lg="3">
          <el-input v-model.trim="form.toUid" size="small" placeholder="接收者" clearable></el-input>
        </el-col>
        <el-col :xs="24" :sm="6" :lg="3">
        ...
        <el-col :xs="24" :sm="12" :lg="6" v-has="'giveLog_search'">
    ...
    <el-row>
      <el-col :span="24">
        <el-table :data="tableData" style="width: 100%" :cell-style="cellStyle" :header-cell-style="rowClass" border v-loading="tableloading">
          <el-table-column prop="fromUid" label="赠送者" show-overflow-tooltip></el-table-column>
          <el-table-column prop="toUid" label="接收者" show-overflow-tooltip></el-table-column>
          <el-table-column prop="propId" label="道具id" show-overflow-tooltip></el-table-column>
          <el-table-column prop="propCount" label="道具数目" show-overflow-tooltip></el-table-column>
