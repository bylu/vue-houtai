  ...
  <div class="app-container">
    ...
    <el-row :gutter="32">
      <el-form ref="form" :model="form">
        ...
        <el-col :xs="24" :sm="12" :lg="6" v-has="'fishRaceSkillLog_search'">
    ...
    <el-row>
      <el-col :span="24">
        <el-table :data="tableData" style="width: 100%" :cell-style="cellStyle" :header-cell-style="rowClass" border v-loading="tableloading">
          ...
          <el-table-column prop="round" label="赛鱼时间" show-overflow-tooltip></el-table-column>
          <el-table-column prop="skillId" label="使用的技能" show-overflow-tooltip></el-table-column>
          <el-table-column prop="fish" label="对哪一条鱼使用" show-overflow-tooltip></el-table-column>
          <el-table-column prop="costs" label="消耗的道具" show-overflow-tooltip></el-table-column>
          <el-table-column prop="drops" label="掉落的道具" show-overflow-tooltip></el-table-column>
    ...
    export default {
        ...
        methods:{
            ...
            onSubmit(pageNum){
              ...
              this.$api.fishRaceSkillLogsearch(param).then(res =>{
