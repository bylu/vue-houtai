<template>
  <div class="app-container">
    <h3 class="showTit">BOSS鱼日志</h3>
    <el-row :gutter="32">
      <el-form ref="form" :model="form">
        <el-col :xs="24" :sm="6" :lg="4">
          <el-input v-model.trim="form.callBossUserid" size="small" placeholder="召唤BOSS的用户ID" clearable></el-input>
        </el-col>
        <el-col :xs="24" :sm="6" :lg="4">
          <el-input v-model.trim="form.killBossUserid" size="small" placeholder="击杀BOSS的用户ID" clearable></el-input>
        </el-col>
        ...
        <el-col :xs="12" :sm="6" :lg="4">
         ...
         <el-col :xs="24" :sm="24" :lg="6" v-has="'bossLog_search'">
    ...
    <el-row>
      <el-col :span="24">
        <el-table :data="tableData" style="width: 100%;margin-top:10px;" :cell-style="cellStyle" :header-cell-style="rowClass" border v-loading="tableloading">
          <el-table-column prop="u" label="召唤用户ID" show-overflow-tooltip></el-table-column>
          <el-table-column prop="ft" label="BOSS鱼ID" show-overflow-tooltip></el-table-column>
          <el-table-column prop="sid" label="房间ID" show-overflow-tooltip></el-table-column>
          <el-table-column prop="ku" label="击杀用户ID" show-overflow-tooltip></el-table-column>
          <el-table-column prop="c" label="召唤时间" show-overflow-tooltip></el-table-column>
          <el-table-column prop="msgTime" label="击杀时间" show-overflow-tooltip></el-table-column>
          <el-table-column prop="receiveTime" label="记录时间" show-overflow-tooltip></el-table-column>
        </el-table>
...
<script>
    export default {
        ...
        methods:{
            ...
            onSubmit(pageNum){
              //u,ku,ft,beginTime，endTime,currentPage,limit
              let param = {
                  u:this.form.callBossUserid,
                  ku:this.form.killBossUserid,
                  ft:this.form.fishid,
              ...
              this.$api.bossLogsearch(param).then(res =>{
