  ...
  <div class="app-container">
    ...
    <el-row :gutter="32">
      <el-form ref="form" :model="form">
        ...
        <el-col :xs="24" :sm="6" :lg="3">
          <el-select v-model="form.allWarheadType" size="small" placeholder="所有弹头">
            <el-option v-for="list in selectList.allWarheadTypelist" :key="list.key" :value="list.key" :label="list.value"></el-option>
          </el-select>
        </el-col>
        ...
        <el-col :xs="12" :sm="6" :lg="4">
         ...
         <el-col :xs="24" :sm="24" :lg="6" v-has="'bombUseLog_search'">
    ...
    <div class="otherdesc">
        使用数量：{{useCount| numTenthousand}} &nbsp;&nbsp;
        累计获得幸运豆：{{getAllScore| numTenthousand}}
    </div>
    <el-row>
      <el-col :span="24">
        <el-table :data="tableData" style="width: 100%" :cell-style="cellStyle" :header-cell-style="rowClass" border v-loading="tableloading">
          ...
          <el-table-column prop="bomb" label="弹头类型" show-overflow-tooltip></el-table-column>
          <el-table-column prop="score" label="获得幸运豆" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.score | numTenthousand }}</template>
          </el-table-column>
          <el-table-column prop="useAt" label="弹头使用时间" show-overflow-tooltip></el-table-column>
          <el-table-column prop="createdAt" label="记录创建时间" show-overflow-tooltip></el-table-column>
        </el-table>
    ...
    export default {
        ...
        methods:{
            ...
            onSubmit(pageNum){
              ...
              //uid,bomb,beginTime，endTime,currentPage,limit
              let param = {
                  uid:this.form.userid,
                  bomb:this.form.allWarheadType,
              ...
              this.$api.bombUseLogsearch(param).then(res =>{
                this.tableloading=false;
                if (res.success) {
                  this.tableData = res.data.records;
                  this.useCount = res.params.useCount;
                  this.getAllScore = res.params.getAllScore;
