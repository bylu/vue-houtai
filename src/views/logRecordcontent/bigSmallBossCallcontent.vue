...
<div>
    <el-table :data="tableData" style="width: 100%" :cell-style="cellStyle" :header-cell-style="rowClass" border>
      <el-table-column prop="fishType" label="fishType" show-overflow-tooltip></el-table-column>
      <el-table-column prop="total" label="total" show-overflow-tooltip></el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    init(){
      ...
      this.$api.skillUseLogboss(param).then(res =>{
        if (res.success) {
