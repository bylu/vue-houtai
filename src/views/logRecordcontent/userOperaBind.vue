<template>
    <div class="showcontent">
      <div class="userOperaTitlecss">绑定解绑查询操作:</div>
        <el-row :gutter="32">
            <el-form ref="form" :model="form">
                <el-col :xs="12" :sm="6" :lg="3">
                    <el-select v-model="form.type" placeholder="请输入" size="small">
                        <el-option v-for="(list,index) in selectList.operaBindTypelist" :key="index" :label="list.value" :value="list.key"></el-option>
                    </el-select>
                </el-col>
            ...
            <el-col :span="24">
                <el-table :data="tableData" style="width: 100%" :cell-style="cellStyle" :header-cell-style="rowClass" border v-loading="tableloading">
                    ...
                    <el-table-column prop="type" label="类型" show-overflow-tooltip>
                      <template slot-scope="scope">{{ scope.row.type | checkBindtype}}</template>
                    </el-table-column>
    ...
    export default {
        ...
        methods:{
            ...
            onSubmit(pageNum){
              ...
              this.$api.recordUserOperationInforecordBindMobile(param).then(res =>{
