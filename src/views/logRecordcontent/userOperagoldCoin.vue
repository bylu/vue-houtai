<template>
    <div class="showcontent">
       <div class="userOperaTitlecss">赠送金币查询操作:</div>
        <el-row :gutter="32">
        ...
        <el-row  :gutter="32">
          <el-col :span="24">
            <el-table :data="tableData" style="width: 100%" :cell-style="cellStyle" :header-cell-style="rowClass" v-loading="tableloading">
              ...
              <el-table-column prop="collectDate" label="操作时间" width="100px"></el-table-column>
              <el-table-column prop="clientIP" label="操作IP"></el-table-column>
              <el-table-column prop="userID" label="赠送对象用户ID"></el-table-column>
              <el-table-column prop="gameid" label="赠送对象游戏ID"></el-table-column>
              <el-table-column prop="accounts" label="赠送对象账号" width="120px"></el-table-column>
              <el-table-column prop="nickname" label="赠送对象昵称"></el-table-column>
              <el-table-column prop="curGold" label="赠送前">
                <template slot-scope="scope"><div v-html="op1(scope.row)"></div></template>
              </el-table-column>
              <el-table-column prop="addGold" label="赠送">
                <template slot-scope="scope"><div v-html="op2(scope.row)"></div></template>
              </el-table-column>
              <el-table-column prop="" label="赠送后">
...
<script>
    export default {
        ...
        methods:{
            ...
            onSubmit(pageNum){
              //type(七个查询按循序1-7), masterID,userID,beginTime,endTime,,currentPage,limit
              let param = {
                type:'1',
