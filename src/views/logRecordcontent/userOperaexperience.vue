<template>
    <div class="showcontent">
      <div class="userOperaTitlecss">赠送经验值查询操作:</div>
        <el-row :gutter="32">
        ...
        <el-row  :gutter="32">
            <el-col :span="24">
                <el-table :data="tableData" style="width: 100%" :cell-style="cellStyle" :header-cell-style="rowClass" border v-loading="tableloading">
                    ...
                    <el-table-column prop="collectDate" label="操作时间"></el-table-column>
                    ...
                    <el-table-column prop="accounts" label="赠送对象账号" ></el-table-column>
        ...
        methods:{
            ...
            op2(data){
              if(data.username == '' || data.username == null){
                ...
                }else if(0>data.addGold){
                  return "<span style='color:green'>"+ this.numTenthousand(data.addGold) +"</span>";
                }
              }else{
                if(data.operation == '赠送奖券'){
                  return data.addGold;
