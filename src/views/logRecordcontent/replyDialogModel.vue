   ...
   <el-form
    ...
    >
        <el-form-item label="id" prop="Id" style="display:none;">
            <el-input v-model="form.Id"  placeholder="填写名称" autocomplete="off" clearable></el-input>
        </el-form-item>
        <el-form-item label="回复内容" prop="replaycontent">
            <el-input v-model="form.replaycontent" placeholder="" size="small" clearable autocomplete="off"></el-input>
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        replaycontent: [
          { required: true, message: "填写回复内容", trigger: "blur" }
        ]
      }
    };
  },
