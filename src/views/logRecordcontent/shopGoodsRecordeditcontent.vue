  ...
  <div>
    <el-form :model="form" :inline="true" ref="form"   label-width="70px" class="demo-ruleForm">
        ...
        <el-form-item label="note1:" prop="note1">
            <el-input v-model.trim="form.note1" size="small" autocomplete="off" clearable></el-input>
        </el-form-item>
        <el-form-item label="note2:" prop="note2" >
            <el-input v-model.trim="form.note2" size="small" autocomplete="off" clearable ></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    init(){
      ...
      this.form.note1=this.getdata.note1;
      this.form.note2=this.getdata.note2;
      this.form.userid=this.getdata.userid;
      this.form.shopid=this.getdata.shopid;
      this.form.status=this.getdata.status;
    },
    //取消按钮操作
    cancel() {
      this.resetForm();
