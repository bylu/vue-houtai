<template>
    <div class="showcontent">
      <div class="userOperaTitlecss">封号解封查询操作:</div>
        <el-row :gutter="32">
            <el-form ref="form" :model="form">
                <el-col :xs="12" :sm="6" :lg="3">
                    <el-select v-model="form.type" placeholder="请输入" size="small">
                        <el-option v-for="(list,index) in selectList.operaReleaseOfTitleTypelist" :key="index" :label="list.value" :value="list.key"></el-option>
                    </el-select>
                </el-col>
                ...
                <el-col :xs="24" :sm="6" :lg="3">
                    <el-input v-model.trim="form.userId" size="small" placeholder="操作对象用户ID" clearable></el-input>
                </el-col>
        ...
        <el-row  :gutter="32">
            <el-col :span="24">
                <el-table :data="tableData" style="width: 100%" :cell-style="cellStyle" :header-cell-style="rowClass" border v-loading="tableloading">
                    ...
                    <el-table-column prop="operatorIp" label="操作员IP" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="userId" label="操作对象用户ID" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="type" label="类型" show-overflow-tooltip>
                      <template slot-scope="scope">{{ scope.row.type | checkFreezeType }}</template>
                    </el-table-column>
                   <el-table-column prop="reason" label="操作原因" show-overflow-tooltip></el-table-column>
    ...
    export default {
        ...
        methods:{
            ...
            onSubmit(pageNum){
              ...
              this.$api.recordUserOperationInforecordFreeze(param).then(res =>{
