  ...
  <div class="app-container">
    ...
    <el-row :gutter="32">
      <el-form ref="form" :model="form">
        ...
        <el-col :xs="24" :sm="24" :lg="6" v-has="'freeGoldAdd_search'">
    ...
    <el-row>
      <el-col :span="24">
        <el-table :data="tableData" style="width: 100%" :cell-style="cellStyle" :header-cell-style="rowClass" border v-loading="tableloading">
          ...
          <el-table-column prop="opt" label="类型">
            <template slot-scope="scope"> {{scope.row.opt | optStatue }}</template>
          </el-table-column>
          <el-table-column prop="targetUid" label="被邀请用户ID"></el-table-column>
          <el-table-column prop="inviteScore" label="获得金币">
            <template slot-scope="scope">{{ scope.row.inviteScore | numTenthousand }}</template>
          </el-table-column>
    ...
    export default {
        ...
        methods:{
            ...
            onSubmit(pageNum){
              ...
              this.$api.freeGoldAddsearch(param).then(res =>{
