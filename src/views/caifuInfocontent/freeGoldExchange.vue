  ...
  <div class="app-container">
    ...
    <el-row :gutter="32">
      <el-form ref="form" :model="form">
        ...
        <el-col :xs="24" :sm="24" :lg="6" v-has="'freeGoldExchange_search'">
    ...
    <el-row>
      <el-col :span="24">
        <el-table :data="tableData" style="width: 100%" :cell-style="cellStyle" :header-cell-style="rowClass" border v-loading="tableloading">
          ...
          <el-table-column prop="boxIdx" label="盒子ID" show-overflow-tooltip>
            <!-- <template slot-scope="scope"> {{scope.boxIdx | optStatue }}</template> -->
          </el-table-column>
          <el-table-column prop="costInviteScore" label="消耗金币" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.costInviteScore | numTenthousand }}</template>
          </el-table-column>
          <el-table-column prop="getTool" label="获得道具" show-overflow-tooltip></el-table-column>
          <el-table-column prop="getScore" label="获得幸运豆" show-overflow-tooltip>
            <template slot-scope="scope">{{ scope.row.getScore | numTenthousand }}</template>
          </el-table-column>
    ...
    export default {
        ...
        methods:{
            ...
            onSubmit(pageNum){
              ...
              this.$api.freeGoldExchangesearch(param).then(res =>{
