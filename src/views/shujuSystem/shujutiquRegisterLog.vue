<template>
    <div class="showcontent">
        <h4 class="showTit">注册日志:</h4>
        <el-row :gutter="24">
            <el-form ref="form" :model="form">
                <el-col :xs="24" :sm="6" :lg="3">
                    <el-input v-model.trim="form.spreaderId" size="small" clearable placeholder="渠道ID"></el-input>
                </el-col>
...
<script>
    export default {
        ...
        methods:{
            onSubmit(){
                this.loading=true;
                this.$api.excelregistrationLog(this.form).then(res =>{
                    this.loading=false;
