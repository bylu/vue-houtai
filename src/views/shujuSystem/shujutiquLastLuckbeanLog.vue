<template>
    <div class="showcontent">
        <h4 class="showTit">幸运豆余量:</h4>
        <el-row :gutter="24">
            <el-form ref="form" :model="form">
                <el-col :xs="24" :sm="6" :lg="3">
                    <el-input v-model.trim="form.beginScore" size="small" placeholder="开始余量" clearable></el-input>
                </el-col>
                <el-col :xs="24" :sm="6" :lg="3">
                    <el-input v-model.trim="form.endScore" size="small" placeholder="结束余量" clearable></el-input>
                </el-col>
...
<script>
    export default {
        ...
        methods:{
            onSubmit(){
                this.loading=true;
                this.$api.excelluckyBeanAllowance(this.form).then(res =>{
                    this.loading=false;
