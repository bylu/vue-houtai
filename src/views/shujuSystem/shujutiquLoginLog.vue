    ...
    <div class="showcontent">
        ...
        <el-row :gutter="24">
            <el-form ref="form" :model="form">
                ...
                <el-col :xs="24" :sm="6" :lg="3">
                    <el-input v-model.trim="form.loginSpreaderid" size="small" placeholder="渠道ID" clearable></el-input>
                </el-col>
...
<script>
    export default {
        ...
        methods:{
            onSubmit(){
                this.loading=true;
                this.$api.exceluserLoginLog(this.form).then(res =>{
                    this.loading=false;
