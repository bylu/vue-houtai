<template>
    <div class="showcontent">
        <h4 class="showTit">道具获取日志:</h4>
        <el-row :gutter="24">
            <el-form ref="form" :model="form">
                <el-col :xs="24" :sm="6" :lg="3">
                    <el-input v-model.trim="form.itemid" size="small" clearable placeholder="道具ID,多个以,隔开"></el-input>
                </el-col>
                ...
                <el-col :xs="24" :sm="6" :lg="2">
                    <el-button type="primary" :loading="loading" size="small" @click="onSubmit()">查询</el-button>
                </el-col>
            </el-form>
        </el-row>
    </div>
...
<script>
    export default {
        ...
        methods:{
            onSubmit(){
                this.loading=true;
                this.$api.excelitemRecord(this.form).then(res =>{
                    this.loading=false;
